...
/* utilities/.libs/lt-identify.c - temporary wrapper executable for .libs/identify.exe
   Generated by libtool (GNU libtool) 2.4.2

   The utilities/identify program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "identify.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/bash\n", f);
  fputs ("\n", f);
  fputs ("# utilities/identify - temporary wrapper script for .libs/identify.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The utilities/identify program cannot be directly executed until all the libt", f);
  fputs ("ool\n", f);
  ...
  fputs ("    echo \"identify.exe:utilities/identify:${LINENO}: libtool wrapper (GNU libto", f);
  fputs ("ol) 2.4.2\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"identify.exe:utilities/identify:${LINENO}: newargv[$lt_dump_args_N]:", f);
  fputs (" $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"identify.exe:utilities/identify:${LINENO}: newargv[0]: $progdir/", f);
  fputs ("$program\" 1>&2\n", f);
