...
/* utilities/.libs/lt-composite.c - temporary wrapper executable for .libs/composite.exe
   Generated by libtool (GNU libtool) 2.4.2

   The utilities/composite program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "Z:\\data\\checkout\\ImageMagick-6.8.9-10\\magick\\.libs;Z:\\data\\checkout\\ImageMagick-6.8.9-10\\wand\\.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "Z:\\data\\inst\\lib;Z:\\data\\inst\\bin;Z:\\data\\checkout\\ImageMagick-6.8.9-10\\magick\\.libs;Z:\\data\\checkout\\ImageMagick-6.8.9-10\\wand\\.libs;";
const char * TARGET_PROGRAM_NAME = "composite.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/bash\n", f);
  fputs ("\n", f);
  fputs ("# utilities/composite - temporary wrapper script for .libs/composite.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The utilities/composite program cannot be directly executed until all the lib", f);
  fputs ("tool\n", f);
  ...
  fputs ("  notinst_deplibs=' magick/libMagickCore-6.Q16.la wand/libMagickWand-6.Q16.la /", f);
  fputs ("data/checkout/ImageMagick-6.8.9-10/magick/libMagickCore-6.Q16.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"composite.exe:utilities/composite:${LINENO}: libtool wrapper (GNU lib", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"composite.exe:utilities/composite:${LINENO}: newargv[$lt_dump_args_N", f);
  fputs ("]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"composite.exe:utilities/composite:${LINENO}: newargv[0]: $progdi", f);
  fputs ("r/$program\" 1>&2\n", f);
  ...
  fputs ("    PATH=/data/inst/lib:/data/inst/bin:/data/checkout/ImageMagick-6.8.9-10/magi", f);
  fputs ("ck/.libs:/data/checkout/ImageMagick-6.8.9-10/wand/.libs:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/data/checkout/ImageMagick-6.8.9-10/magick/.libs:/data/checkout/Image", f);
  fputs ("Magick-6.8.9-10/wand/.libs:$PATH\"\n", f);
  fputs ("\n", f);
