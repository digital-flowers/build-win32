...
/* utilities/.libs/lt-compare.c - temporary wrapper executable for .libs/compare.exe
   Generated by libtool (GNU libtool) 2.4.2

   The utilities/compare program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "compare.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/bash\n", f);
  fputs ("\n", f);
  fputs ("# utilities/compare - temporary wrapper script for .libs/compare.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The utilities/compare program cannot be directly executed until all the libto", f);
  fputs ("ol\n", f);
  ...
  fputs ("    echo \"compare.exe:utilities/compare:${LINENO}: libtool wrapper (GNU libtool", f);
  fputs (") 2.4.2\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"compare.exe:utilities/compare:${LINENO}: newargv[$lt_dump_args_N]: $", f);
  fputs ("lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"compare.exe:utilities/compare:${LINENO}: newargv[0]: $progdir/$p", f);
  fputs ("rogram\" 1>&2\n", f);
