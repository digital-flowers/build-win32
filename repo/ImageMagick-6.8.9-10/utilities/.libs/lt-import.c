...
/* utilities/.libs/lt-import.c - temporary wrapper executable for .libs/import.exe
   Generated by libtool (GNU libtool) 2.4.2

   The utilities/import program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "import.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/bash\n", f);
  fputs ("\n", f);
  fputs ("# utilities/import - temporary wrapper script for .libs/import.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The utilities/import program cannot be directly executed until all the libtoo", f);
  fputs ("l\n", f);
  ...
  fputs ("    echo \"import.exe:utilities/import:${LINENO}: libtool wrapper (GNU libtool) ", f);
  fputs ("2.4.2\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"import.exe:utilities/import:${LINENO}: newargv[$lt_dump_args_N]: $lt", f);
  fputs ("_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"import.exe:utilities/import:${LINENO}: newargv[0]: $progdir/$pro", f);
  fputs ("gram\" 1>&2\n", f);
